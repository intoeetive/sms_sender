...
class Textmagic {
    ...
    public function __construct($config = array())
    {
        ...
        $this->_config['api_username'] = $config['sms_username'];
        $this->_config['api_password'] = $config['sms_password'];
    }
     ...
     *
     */
    public function send($phones, $text)//, $is_unicode = true, $send_time = false)
    {
